window.__require = function e(t, n, o) {
          ...
          t.prototype.end = function() {
              ...
              if (0 == this.endOne) {
                  for (var t = 0, n = function(n) {
                      setTimeout(function() {
                          null != e.fruitNode.children[n] && (e.createFruitL(e.fruitNode.children[n].getComponent("fruitData").fruitNumber, e.fruitNode.children[n].position, e.fruitNode.children[n].width),
  ...
  InputController: [function(e, t, n) {
      ...
      var a = e("./GameFunction")
        ...
        , p = function(e) {
          ...
          ,
          t.prototype.update = function(e) {
              cc.find("Canvas/lineNode").childrenCount && (this.autoCreateFruit += e,
              this.autoCreateFruit >= 4 && 0 == a.default.Instance.endOne && a.default.Instance.createOneFruit(s.default.RandomInteger(1, 5))),
              3 == cc.find("Canvas/lineNode").childrenCount && (this.autoCreateFruit = 0)
          }
          ,
          ...
          t.prototype.onTouchEnd = function(e) {
              ...
              this.scheduleOnce(function() {
                  ...
                  t.createFruitCount++) : t.createFruitCount >= 1 && (a.default.Instance.createOneFruit(s.default.RandomInteger(1, 5)),
                  t.createFruitCount++))
              }, .5))
          }
          ,
  ...
  MainGameJS: [function(e, t, n) {
      ...
      cc.Class({
          ...
          AdsLink: function() {
              window.location.href = "https://activity.doumobfour.club/horse?appkey=b0fb21c60e567a62d89abc4abb863f96&adSpaceKey=7d63fe65d21800c295ff7fa9bd89cee8&from=H5&1=1"
          },
      ...
      var a = e("../common/PlayerInfo")
        ...
        , f = function(e) {
          ...
          t.prototype.adsButtonFunc = function() {
              window.location.href = "https://activity.doumobfour.club/horse?appkey=b0fb21c60e567a62d89abc4abb863f96&adSpaceKey=d2895117ce7cc2be0a7d035bb07ff0d3&1=1https://activity.doumobfour.club/horse?appkey=b0fb21c60e567a62d89abc4abb863f96&adSpaceKey=d2895117ce7cc2be0a7d035bb07ff0d3&1=1"
          }
          ,
        ...
        , m = function(e) {
          ...
          t.prototype.onBeginContact = function(e, t, n) {
              ...
              "fruit" == n.node.group) {
                  ...
                  if (c == r && c < 12 && r < 12 ? (this.pengzhuangCount += 1,
                  ...
                  cc.tween(t.node).to(.1, {
                      ...
                      n.node.destroy(),
                      t.node.destroy()
                  }).start())) : c == r && 12 == c && 12 == r && (this.pengzhuangCount += 1,
                  0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + 1,
                  u.default.Instance.SetScoreTween(a.default.score),
                  n.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                  n.node.getComponent(cc.PhysicsCircleCollider).apply(),
                  ...
                  c == r && 9 == c && 9 == r) {
                      ...
                      var p = new cc.Node;
                      p.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10],
                      p.parent = cc.find("Canvas/upEffectParent"),
                      p.position = cc.v2(0, -500),
                      p.scale = 0;
                      var f = new cc.Node;
                      f.addComponent(cc.Sprite).spriteFrame = l.default.Instance.caidia[6],
                      f.scale = 1,
                      f.parent = p,
                      f.position = cc.v2(0),
                      cc.tween(f).by(5, {
                      ...
                      var h = new cc.Node;
                      h.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[10],
                      h.parent = p,
                      h.position = cc.v2(0),
                      d.default.Instance.Play(4, !1, 1),
                      i.default.Instance.ribbonEffect(cc.v2(0, 0)),
                      p.runAction(cc.sequence(cc.spawn(cc.jumpBy(1, 0, 0, 300, 1), cc.scaleTo(1, 3)), cc.delayTime(1), cc.spawn(cc.moveTo(1, cc.v2(0, 500)), cc.scaleTo(1, 0)), cc.callFunc(function() {
                          a.default.score += 100,
                          u.default.Instance.SetScoreTween(a.default.score),
                          s.active = !1,
                          a.default.playerTouch = !0,
